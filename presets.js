...
export const FILM_DATA = {
    ...
    'kodak-tmax-p3200': {
        ...
        manufacturer: 'Kodak',
        type: 'black-white',
        description: 'Высокочувствительная T-гранулярная плёнка',
        defaultISO: 3200
    },
    'kodak-double-x': {
...
export const DEVELOPMENT_TIMES = {
    ...
    'kodak-tmax-100': {
        ...
        'kodak-xtol': {
            'stock': { 100: 330, 500: 900 },
            '1+1': { 100: 420, 500: 1080 }
        },
        'kodak-hc110': {
            'A 1+15': { 100: 330 },
            'B 1+31': { 100: 420 },
    ...
    'kodak-tmax-p3200': {
        ...
        'kodak-xtol': {
            'stock': { 1600: 690, 3200: 810, 6400: 915 },
            '1+1': { 1600: 960, 3200: 1110, 6400: 1230 }
        },
        'kodak-hc110': {
            'A 1+15': { 3200: 960 },
            'B 1+31': { 3200: 1140 },
